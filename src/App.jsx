 ...
 <div className="relative">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {showChatbot ? (
          ...
          <button
            onClick={() => setShowChatbot(!showChatbot)}
            className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all"
          >
